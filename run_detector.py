...
from models import GNN, HetNet as Net, HetNetLogi as NetLogi
from graph_loader import NaiveHetDataLoader, NaiveHetGraph
from data_utils import create_naive_het_graph_from_edges as _create_naive_het_graph_from_edges
...
create_naive_het_graph_from_edges = mem.cache(
    _create_naive_het_graph_from_edges)
...
def main(path_g, path_feat_db='data/store.db', path_result='exp_result.csv',
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        x0 = fstore[g.get_seed_nodes(train_range)[0]]
